...
import { ResponsiveContainer , LineChart , CartesianGrid, XAxis, YAxis, Tooltip, Line, BarChart , Bar , LabelList } from 'recharts';
import { useTranslation } from "react-i18next";
import { useDashboardStatsCharts, type StatsItem } from '../../hooks/useDashboardStatsCharts';
...
const today = new Date().toISOString().slice(0, 10); // e.g. "2025-07-24"
  ...
  if (error) return <div className=' text-red-700'>{t('Error loading Chart data')}</div>;
